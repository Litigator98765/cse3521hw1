...
# This is a modified version of the abovementioned code, provided at 
# The Ohio State University, by Prashant Serai (serai.1@osu.edu)
...
def loadModuleFile(moduleName, filePath):
    with open(filePath, 'r') as f:
        try:
            ...
            #try looking once more in the py subdirectory
            return imp.load_module(moduleName, f, "py/%s.py" % moduleName, (".py", "r", imp.PY_SOURCE))
...
def evaluate(generateSolutions, testRoot, moduleDict, exceptionMap=ERROR_HINT_MAP,
    ...
    test_subdirs = getTestSubdirs(testParser, testRoot, questionToGrade)[:4] #prash
